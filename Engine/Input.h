...
namespace Input
{
	...
	bool IsKeyAny();				//いずれかのキーを押している間
	bool IsKeyAnyDown();			//いずれかのキーを押した瞬間
	bool IsKeyAnyUp();				//いずれかのキーを離した瞬間
	bool IsKeyAdd();				//押しているキーが前回よりも多いか
	bool IsKeyRemove();				//押しているキーが前回よりも少ないか
